...
Separate Vergleichsversion auf `develop`; V1 bleibt die reguläre Leistungsseite.

- DE: `/de/website-erstellen-lassen/v2/#umfang`
- EN: `/en/website-design/v2/#umfang`
- V1: `/de/website-erstellen-lassen/#umfang`
...
- Vorschau `noindex, follow`, Canonical/Markdown auf die reguläre Seite; nicht in Sitemap/Leistungsmenü aufgenommen. Sprachwechsel bleibt innerhalb V2.
